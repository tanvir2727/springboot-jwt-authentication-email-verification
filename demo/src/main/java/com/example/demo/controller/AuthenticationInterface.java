...
public interface AuthenticationInterface {
    ...
    @Operation(summary = "Register a user",description = "This API registers a new user if the user is not already present in the records, and sends an email to the user for verification.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Login user",description = "Authentication and log in a user.")
    @ApiResponses(value = {
    ...
    @ApiResponses(value = {
            ...
            content = @Content(mediaType = "application/json",
            schema = @Schema(implementation = GeneralAPIResponse.class))),
            @ApiResponse(responseCode = "500", description = "Internal Srver Error: Failed to send OPT email.",
            content = @Content(mediaType = "application/json",
            schema = @Schema(implementation = GeneralAPIResponse.class)))
    })
