...
//    Critical Issue: The @Retryable mechanism won't work here because you're catching the exceptions. Spring Retry only triggers when exceptions propagate out of the method. Remove the try-catch to let @Retryable work:

//    public CompletableFuture<Integer> sendEmailWithRetry(String to, String otp) throws MessagingException, UnsupportedFlavorException {
//        try{
...
//    }
    public CompletableFuture<Integer> sendEmailWithRetry(String to, String otp)
        ...
        sendOtpByEmail(to, otp);  // Let exceptions propagate - @Retryable will catch and retry
        return CompletableFuture.completedFuture(1);
    }
...
//    }
    ...
    public void sendOtpByEmail(String to, String otp) throws MessagingException, UnsupportedEncodingException {
        ...
        String subject = "One Time Password (OTP) to verify your Email Address";
